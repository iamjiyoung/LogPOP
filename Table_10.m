% Reproduce the MATLAB results reported in Table 10.
...
for pidx = 1:num_profiles
    ...
    for sidx = 1:numel(config.seeds)
        ...
        instance = Table_7_10_generate_instance(config.n, config.m, ...
        ...
        tighter = Table_7_10_solve_log_relaxation(instance, true, config.m+1);
        ...
        try
            ...
            full = Table_7_10_solve_direct_product(product_instance, full_sos_required_order(row), ...
