function out = Table_5_solve_log_relaxation(instance, use_lme, ord)
%TABLE_5_SOLVE_LOG_RELAXATION Solve a standard or LME log relaxation.
% This helper is called by Table_5.m. Do not run it
% directly. It constructs the selected relaxation and delegates the
% moment-SDP calculation to Table_5_solve_log_moment_relaxation.m.
...
out = Table_5_solve_log_moment_relaxation(x, p, instance.weights, instance.weights, ...
