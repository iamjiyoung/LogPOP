function out = Table_5_solve_log_moment_relaxation( ...
        x, p, solve_weights, report_weights, Ktheta, ord, ...
        flat_max, flat_min, flat_degree)
%TABLE_5_SOLVE_LOG_MOMENT_RELAXATION Build and solve a log-moment relaxation.
% This routine is called indirectly by Table_5.m through
% Table_5_solve_log_relaxation.m. It is not a main script and
