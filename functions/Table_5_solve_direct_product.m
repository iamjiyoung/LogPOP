function out = Table_5_solve_direct_product(instance, min_ord, max_extra_orders, max_psd_dim)
%TABLE_5_SOLVE_DIRECT_PRODUCT Solve the direct-product Moment-SOS model.
% This helper is called by Table_5.m for integer exponents.
...
for ord = min_ord:min_ord+max_extra_orders
    ...
    candidate = Table_5_solve_polynomial_relaxation(x, objective_poly, Ktheta, ord, ord);
