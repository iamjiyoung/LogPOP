function out = Table_5_solve_sqp(instance, num_starts)
%TABLE_5_SOLVE_SQP Compute the best feasible value by multistart SQP.
% This helper is called by Table_5.m and should not be run
