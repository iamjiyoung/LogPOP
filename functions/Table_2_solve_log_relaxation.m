function out = Table_2_solve_log_relaxation(instance, use_lme, ord)
% Solve the standard or LME relaxation for Table 2.
%
...
out = Table_2_solve_log_moment_relaxation(x, p, instance.weights, instance.weights, ...
