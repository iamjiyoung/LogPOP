...
%TABLE_6_7_SOLVE_DIRECT_PRODUCT Solve the direct-product Moment-SOS model.
...
for ord = min_ord:min_ord+max_extra_orders
    ...
    candidate = Table_5_6_solve_polynomial_relaxation(x, objective_poly, Ktheta, ord, ord);
